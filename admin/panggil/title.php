...
<head>
    ...
    <link rel="stylesheet" href="<?php echo url(); ?>vendor/css/admin.css">
</head>
<body>
    <!-- Navbar -->
    <div class="navbar">
        ...
        <ul>
            ...
            <li class="active"><a href="index.php?m=panggilan">Panggil</a></li>
  ...
  <audio id="tingtung" src="../vendor/audio/tingtung.mp3"></audio>
